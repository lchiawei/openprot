...
impl From<EraseTime> for core::time::Duration {
    fn from(value: EraseTime) -> Self {
        core::time::Duration::from(value.units()) * (value.count() as u32 + 1)
    }
}
...
mod duration_tests {
    ...
    fn test_duration() {
        ...
        assert_eq!(
            core::time::Duration::from(et),
            core::time::Duration::from_millis(384)
        );
    }
}
...
impl From<EraseTimeUnit> for core::time::Duration {
    fn from(value: EraseTimeUnit) -> Self {
        match value {
            EraseTimeUnit::_1ms => core::time::Duration::from_millis(1),
            EraseTimeUnit::_16ms => core::time::Duration::from_millis(16),
            EraseTimeUnit::_128ms => core::time::Duration::from_millis(128),
            EraseTimeUnit::_1s => core::time::Duration::from_secs(1),
        }
    }
}
...
impl From<PageProgramTime> for core::time::Duration {
...
impl From<PageProgramTimeUnit> for core::time::Duration {
    fn from(value: PageProgramTimeUnit) -> Self {
        match value {
            PageProgramTimeUnit::_8us => core::time::Duration::from_micros(8),
            PageProgramTimeUnit::_64us => core::time::Duration::from_micros(64),
        }
    }
}
...
impl From<ByteProgramTime> for core::time::Duration {
    fn from(value: ByteProgramTime) -> Self {
        core::time::Duration::from(value.unit()) * (value.count() as u32 + 1)
    }
}
...
impl From<ByteProgramTimeUnit> for core::time::Duration {
    fn from(value: ByteProgramTimeUnit) -> Self {
        match value {
            ByteProgramTimeUnit::_1us => core::time::Duration::from_micros(1),
            ByteProgramTimeUnit::_8us => core::time::Duration::from_micros(8),
        }
    }
}
...
impl From<ChipEraseTime> for core::time::Duration {
...
impl From<ChipEraseTimeUnit> for core::time::Duration {
    fn from(value: ChipEraseTimeUnit) -> Self {
        match value {
            ChipEraseTimeUnit::_16ms => core::time::Duration::from_millis(16),
            ChipEraseTimeUnit::_256ms => core::time::Duration::from_millis(256),
            ChipEraseTimeUnit::_4s => core::time::Duration::from_secs(4),
            ChipEraseTimeUnit::_64s => core::time::Duration::from_secs(64),
        }
    }
}
...
impl From<Interval64us> for core::time::Duration {
    fn from(value: Interval64us) -> Self {
        core::time::Duration::from_millis(64) * (value.counts_64ms() as u32)
    }
}
...
impl From<DurationEnumAUnit> for core::time::Duration {
    fn from(value: DurationEnumAUnit) -> Self {
        match value {
            DurationEnumAUnit::_128ns => core::time::Duration::from_nanos(128),
            DurationEnumAUnit::_1us => core::time::Duration::from_micros(1),
            DurationEnumAUnit::_8us => core::time::Duration::from_micros(8),
            DurationEnumAUnit::_64us => core::time::Duration::from_micros(64),
        }
    }
}
...
impl MemoryDensity {
    pub const fn from_byte_len(byte_len: u32) -> Result<Self, ErrorCode> {
        ...
        if let Some(bit_len) = byte_len.checked_mul(8)
            && bit_len <= 0x8000_0000
        {
            return Ok(Self(bit_len - 1));
        }
    ...
    pub const fn byte_len(&self) -> Result<u32, ErrorCode> {
        ...
        let power = (self.0 & !0x8000_0000) - 3;
        if power > 31 {
            return Err(error::FLASH_GENERIC_SFDP_INVALID_MEMORY_DENSITY);
        }
        Ok(1 << power)
...
impl<R: RandomRead<Error: From<ErrorCode>>> SfdpReader<R> {
    ...
    fn read_table_common(
        ...
        self.reader.read(
            parameter_header.ptr.as_usize(),
            &mut target_slice[..bytes_len],
        )?;
        Ok(())
    }
